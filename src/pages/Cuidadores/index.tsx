  ...
  return (
    <div>
      ...
      <div className="pl-14 text-5xl pb-10">
        <h1 className="font-dosis">Conectamos cuidadores com clientes</h1>
      </div>
      ...
      {/* Compromisso */}
      <div className="px-14">
        <h1 className="text-5xl text pb-10">
      ...
      {/* Experiencias */}
      <div className="">
        <h1 className="text-5xl px-14 pb-10">
          O que os cuidadores dizem sobre começar a trabalhar com o auxílio da
          CarePlus?
        </h1>
        <div className="flex justify-center">
          <div className="grid grid-cols-2 pb-10 px-28">
            {/* celeste */}
